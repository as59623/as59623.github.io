/*
2019/05/24 22:39:56
jquery.backstretch 10.97 KB -> 5.35 KB 51.21%
*/
;
(function ($, window, undefined) {
    ...
    var Backstretch = function (container, images, options) {
        ...
        this.$wrap = $existing.length ? $existing : $('<div class="backstretch ' + this.options.style + '"></div>').css(styles.wrap).appendTo(this.$container);
        if (!this.isBody) {
    ...
    Backstretch.prototype = {
        ...
        show: function (newIndex) {
            ...
            self.$img = $('<img />').css(styles.img).bind('load', function (e) {
                ...
                self.resize();
                self.options.callback(e.target, newIndex);
            }).appendTo(self.$wrap);
